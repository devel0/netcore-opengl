...
public class GLContext : IDisposable
{
    ...
    static Assembly? _netcore_opengl_render_assembly = null;

    internal static Assembly netcore_opengl_render_assembly
    {
        get
        {
    ...
    {
        var names = GetEmbeddedResourceNames(netcore_opengl_render_assembly);
